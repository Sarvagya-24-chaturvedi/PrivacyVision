import { ConfidenceTier, PrivacyPolicy, SensitiveDataType, SensitiveDetection } from "../shared/privacy";
...
export class PrivacyPolicyManager {
  ...
  public shouldRedact(detection: SensitiveDetection): boolean {
  ...
  public static getPlaceholder(type: SensitiveDataType): string {
    switch (type) {
      case "PASSWORD":
      case "PIN":
      case "OTP":
